import { ATTRIBUTS, UNIVERS, getCompetence, getClasse, getUnivers } from "./univers.js";
function initialiser(nomUniv = "Médiéval fantastique") {
    // Correction du nom de variable (nomUniv)
    ...
    UNIVERS.forEach(u => {
        ...
        // Sélectionner l'univers par défaut si correspond
        if (u.nom === nomUniv) {
